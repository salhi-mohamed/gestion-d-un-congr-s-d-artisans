...
{
  int nbphotos;
  cout<<"saisir l id de la creation : "<<endl;
  cin>>id;
  cout<<"saisir le nom de la creation : "<<endl;
  cin>>nom;
  cout<<"saisir la description de la creation : "<<endl;
  cin>>description;
  cout<<"saisir le nombre des photos correspendants a cette creation : "<<endl;
  cin>>nbphotos;
  string photo;
  for(int i=0;i<nbphotos;i++)
  {
      cout<<"saisir la photo : "<<endl;
      cin>>photo;
